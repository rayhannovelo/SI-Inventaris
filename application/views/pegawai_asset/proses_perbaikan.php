                    ...
                    <div class="col-md-12">                        
                        <div class="ibox">
                            ...
                            <div class="ibox-content">
                                ...
                                <form class="m-t" role="form" action="<?php echo site_url('perbaikan/proses_perbaikan_form/'.$value['id_perbaikan']); ?>" method="post" enctype="multipart/form-data" onsubmit="return confirm('Stok opname akan diperbarui. Apakah Anda yakin?');">
                                <input type="hidden" name="id_pengguna" value="<?php echo $value['id_pengguna']; ?>">
                                <input type="hidden" name="perihal" value="Perbaikan Barang">
                                <div class="row">
                                    <div class="col-md-6">
