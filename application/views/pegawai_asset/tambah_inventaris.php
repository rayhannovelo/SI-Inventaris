                    ...
                    <div class="col-md-12">                        
                        <div class="ibox">
                            ...
                            <div class="ibox-content">
                                <form class="m-t" role="form" action="<?php echo site_url('daftar_inventaris/tambah_inventaris_form/'); ?>" method="post" enctype="multipart/form-data" onsubmit="return confirm('Data inventaris akan ditambah. Apakah Anda yakin?');">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="perihal" class="form-control">
                                                    ...
                                                    <option value="Perbaikan Barang">Perbaikan Barang</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="id_pengguna" class="form-control">
                                                <?php foreach ($daftar_toko as $key => $value) { ?>
                                                    <option value="<?php echo $value['id_pengguna']; ?>"><?php echo $value['nama_pengguna']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
