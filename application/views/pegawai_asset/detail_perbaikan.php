                    ...
                    <div class="col-md-12">                        
                        <div class="ibox">
                            ...
                            <div class="ibox-content">
                                ...
                                <form class="m-t" role="form" action="<?php echo site_url('daftar_perbaikan/edit_perbaikan_form/'.$value['id_perbaikan']); ?>" method="post" enctype="multipart/form-data" onsubmit="return confirm('Data perbaikan akan ditambah. Apakah Anda yakin?');">
                                <?php } ?>
                                <?php foreach ($kategori_barang as $key => $value) { ?>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" align="center">
                                        ...
                                        <tbody>
                                            <?php 
                                                foreach($barang_perbaikan as $key => $value1) { 
