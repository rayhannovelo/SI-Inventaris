                    ...
                    <div class="col-md-12">                        
                        <div class="ibox">
                            ...
                            <div class="ibox-content">
                                ...
                                <form class="m-t" role="form" action="<?php echo site_url('inventaris/stok_opname_form/'.$value['id_inventaris']); ?>" method="post" enctype="multipart/form-data" onsubmit="return confirm('Stok opname sudah dilaksanakan. Apakah Anda yakin?');">
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" align="center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php 
                                                        if($value1['masa_barang'] < 5) { 
                                                            ...
                                                            $x = substr($value1['kode_barang'], 11, 3);
                                                            for($i = 0; $i < $value1['kuantitas_toko']; $i++) {
                                                                $nomor = str_pad($x, 3, "0", STR_PAD_LEFT);
                                                                $string = substr_replace($value1['kode_barang'], $nomor, 11, 3);
                                                                echo '<li>'.$string.'</li>';
                                                                $x++;
                                                            }
                                                        } 
                                                ...
                                                <td>
                                                    <input type="number" name="kuantitas_pengawas[]" value="0" class="form-control">
                                                </td>
                                                <td>
                                                    <input type="number" name="status_baik[]" value="0" class="form-control">
                                                </td>
                                                <td>
                                                    <input type="number" name="status_rusak[]" value="0" class="form-control">
                                                </td>
                                                <td>
