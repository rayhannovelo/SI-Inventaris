                    ...
                    <div class="col-md-12">                        
                        <div class="ibox">
                            ...
                            <div class="ibox-content">
                                <form class="m-t" role="form" action="<?php echo site_url('permintaan/tambah_permintaan_form/'); ?>" method="post" enctype="multipart/form-data" onsubmit="return confirm('Data permintaan akan ditambah. Apakah Anda yakin?');">
                                <div class="row">
                                    <div class="col-md-12">
